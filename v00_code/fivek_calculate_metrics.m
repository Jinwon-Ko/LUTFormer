...
% split_pwd = split(pwd, '/');
% output_dir = replace(split_pwd{end}, '_code', '_output');
% test_dir = fullfile('..', output_dir, 'display/Retouching_FiveK_expertC/analysis/pred');
% gt_dir = fullfile('..', output_dir, 'display/Retouching_FiveK_expertC/analysis/gt');
% calculate_metrics(test_dir, gt_dir);